...
Years_in_Current_Role = st.number_input("Years in Current Role", min_value=0.0, value=2.0)
Years_Since_Last_Promotion = st.number_input("Years Since Last Promotion", min_value=0.0, value=1.0)

Work_Life_Balance = st.slider("Work Life Balance", 1, 4, 3)
Job_Satisfaction = st.slider("Job Satisfaction", 1, 5, 3)
Performance_Rating = st.slider("Performance Rating", 1, 4, 3)

Training_Hours_Last_Year = st.number_input("Training Hours Last Year", min_value=0.0, value=40.0)
Project_Count = st.number_input("Project Count", min_value=0.0, value=5.0)
Distance_From_Home = st.number_input("Distance From Home", min_value=0.0, value=10.0)
...
Promotion_Wait_Ratio = Years_Since_Last_Promotion / (Years_at_Company + 1)
